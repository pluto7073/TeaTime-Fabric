...
public abstract class SpecialSmeltingRecipe extends SmeltingRecipe {
    ...
    public SpecialSmeltingRecipe(Identifier id, CookingRecipeCategory category) {
    ...
    @Override
    public abstract ItemStack craft(Inventory inventory, DynamicRegistryManager manager);
}
